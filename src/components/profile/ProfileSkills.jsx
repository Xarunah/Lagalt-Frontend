...
function ProfileSkills(props) {
  ...
  return (
    <div>
      ...
      <input
        className="bg-gray-50 resize-none w-full p-2 focus:border-rose-400 focus:border-2 rounded-lg font-playfair border-gray-300 border-2 outline-none focus:bg-gray-200"
        ref={skillInput}
